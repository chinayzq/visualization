        ...
        ;(s = t("omggif").GifReader),
          ...
          (o = (function () {
            function t(t) {
              this._animatorPromise = t.then(function (t) {
                var e
                return (
                  (e = new s(new Uint8Array(t))),
                  i.decodeFramesAsync(e).then(function (t) {
                    return new r(e, t)
                  })
                )
              })
            ...
            return (
              (t.getCanvasElement = function (t) {
                var e, n
                if (
                  "string" == typeof t &&
                  "CANVAS" === (null != (n = e = document.querySelector(t)) ? n.tagName : void 0)
                )
                  return e
              ...
              (t.prototype.animate = function (e) {
                var n
                return (
                  (n = t.getCanvasElement(e)),
                  this._animatorPromise.then(function (t) {
            ...
            return (
              ...
              (t.decodeFramesAsync = function (e) {
                ...
                return a.map(
                  function () {
                    r = []
                    for (var t = 0, n = e.numFrames(); n >= 0 ? n > t : t > n; n >= 0 ? t++ : t--) r.push(t)
                    return r
                  }.apply(this),
                  function (n) {
                    return t.decodeFrame(e, n)
              ...
              (t.decodeFrame = function (t, e) {
                ...
                return (
                  (n = t.frameInfo(e)),
                  (n.pixels = new Uint8ClampedArray(t.width * t.height * 4)),
                  t.decodeAndBlitFrameRGBA(e, n.pixels),
                  n
                )
              }),
              t
          ...
          (r = (function () {
            function t(t, e) {
              ...
              ;(this._reader = t),
                (this._frames = e),
                (this._advanceFrame = c(this._advanceFrame, this)),
                (this._nextFrameRender = c(this._nextFrameRender, this)),
                (this._nextFrame = c(this._nextFrame, this)),
                (n = this._reader),
                (this.width = n.width),
            ...
            return (
              (t.createBufferCanvas = function (t, e, n) {
                var r, i, o
                return (
                  ...
                  (r.width = t.width),
                  (r.height = t.height),
                  (o = i.createImageData(e, n)),
                  o.data.set(t.pixels),
                  i.putImageData(o, -t.x, -t.y),
                  r
                )
              }),
              ...
              (t.prototype._nextFrameRender = function () {
                ...
                if (this._running)
                  return (
                    (t = this._frames[this._frameIndex]),
                    null != (e = this.onFrame) && e.apply(this, [t, this._frameIndex]),
              ...
              (t.prototype._enqueueNextFrame = function () {
                ...
                for (this._advanceFrame(); this._running; ) {
                  if (
                    ((n = this._frames[this._frameIndex]),
                    (e = new Date().valueOf() - this._lastTime),
                    (this._lastTime += e),
                    (this._delayCompensation += e),
                    (r = 10 * n.delay),
                    (t = r - this._delayCompensation),
                    (this._delayCompensation -= r),
                    !(0 > t))
                  ) {
              ...
              (t.prototype.animateInCanvas = function (e, n) {
                ...
                return (
                  null == n && (n = !0),
                  n && ((e.width = this.width), (e.height = this.height)),
                  (r = e.getContext("2d")),
                  null == this.onDrawFrame &&
                    (this.onDrawFrame = function (t, e, n) {
                      return t.drawImage(e.buffer, e.x, e.y)
                    }),
                  null == this.onFrame &&
                    (this.onFrame = (function (n) {
                      return function (i, o) {
                        var s, a
                        switch (
                          (null == i.buffer && (i.buffer = t.createBufferCanvas(i, n.width, n.height)),
                          "function" == typeof n.disposeFrame && n.disposeFrame(),
                          i.disposal)
                        ) {
                          case 2:
                            ...
                            break
                          case 3:
                            ;(a = r.getImageData(0, 0, e.width, e.height)),
                              (n.disposeFrame = function () {
          ...
          (u.Decoder = i),
          (u.Animator = r),
          "undefined" != typeof window && null !== window && (window.gifler = u),
                  ...
                  function (e, n, r) {
                    ...
                    ;(i.prototype.disableTrampolineIfNecessary = function () {
                      ...
                      (i.prototype.fatalError = function (e, n) {
                        n
                          ? (t.stderr.write("Fatal " + (e instanceof Error ? e.stack : e)), t.exit(2))
                          : this.throwLater(e)
                      }),
                    ...
                    e.exports = function (t, e, n, r) {
                      ...
                      ;(t.prototype.bind = function (o) {
                        ...
                        if ((l._setBoundTo(c), c instanceof t)) {
                          var f = { promiseRejectionQueued: !1, promise: l, target: h, bindingPromise: c }
                    ...
                    n.exports = function (n, r) {
                      ...
                      function v(t, e, r) {
                        if (Y.warnings) {
                          ...
                          else if (Y.longStackTraces && (i = n._peekContext())) i.attachExtraTrace(o)
                          else {
                            var s = C(o)
                            o.stack = s.message + "\n" + s.stack.join("\n")
                          }
                      ...
                      function C(t) {
                        var e = t.stack,
                          n = t.toString()
                        return (
                          (e = "string" == typeof e && e.length > 0 ? w(t) : ["    (No stack trace)"]),
                          { message: n, stack: b(e) }
                        )
                      }
                      function j(t, e, n) {
                      ...
                      var A,
                        ...
                        $ = !(0 == H.env("BLUEBIRD_LONG_STACK_TRACES") || (!q && !H.env("BLUEBIRD_LONG_STACK_TRACES")))
                      ;(n.prototype.suppressUnhandledRejections = function () {
                        ...
                        (n.prototype._ensurePossibleRejectionHandled = function () {
                          0 === (2097152 & this._bitField) &&
                            ...
                            D.invokeLater(this._notifyUnhandledRejection, this, void 0))
                        }),
                        ...
                        (n.prototype._notifyUnhandledRejection = function () {
                          if (this._isRejectionUnhandled()) {
                            ...
                            this._setUnhandledRejectionIsNotified(), F("unhandledRejection", O, t, this)
                          }
                        }),
                        ...
                        (n.longStackTraces = function () {
                          if (D.haveItemsQueued() && !Y.longStackTraces)
                            throw new Error(
                          ...
                          !Y.longStackTraces &&
                            E() &&
                            ((Y.longStackTraces = !0),
                            (n.prototype._captureStackTrace = f),
                        ...
                        (n.config = function (t) {
                          if (
                            ((t = Object(t)),
                            "longStackTraces" in t && t.longStackTraces && n.longStackTraces(),
                            "warnings" in t && (Y.warnings = !!t.warnings),
                            "cancellation" in t && t.cancellation && !Y.cancellation)
                          ) {
                            if (D.haveItemsQueued())
                              throw new Error("cannot enable cancellation after promises are in use")
                            ;(n.prototype._clearCancellationData = u),
                              (n.prototype._propagateFrom = c),
                              (n.prototype._onCancel = s),
                              (n.prototype._setOnCancel = a),
                              (n.prototype._attachCancellationCallback = o),
                              (n.prototype._execute = i),
                              (G = c),
                              (Y.cancellation = !0)
                          }
                        }),
                      ...
                      H.inherits(R, Error),
                        ...
                        (R.prototype.attachExtraTrace = function (t) {
                          if (!t.__stackCleaned__) {
                            this.uncycle()
                            for (var e = C(t), n = e.message, r = [e.stack], i = this; void 0 !== i; )
                              r.push(b(i.stack.split("\n"))), (i = i._parent)
                            g(r),
                              m(r),
                              H.notEnumerableProp(t, "stack", y(n, r)),
                              H.notEnumerableProp(t, "__stackCleaned__", !0)
                          }
                        })
                      var X,
                        K = (function () {
                          ...
                          if (
                            ...
                            ;(Error.stackTraceLimit += 6), (U = t), (B = e)
                        ...
                        J = (function () {
                          ...
                          n &&
                            (X = function (t, n) {
                              ...
                              return (
                                e
                                  ? (r = new self.CustomEvent(t, { detail: n, bubbles: !1, cancelable: !0 }))
                                  : self.dispatchEvent &&
                                    ((r = document.createEvent("CustomEvent")), r.initCustomEvent(t, !1, !0, n)),
                                r ? !self.dispatchEvent(r) : !1
                              )
                            })
                          var o = {}
                          return (
                            (o.unhandledRejection = "onunhandledRejection".toLowerCase()),
                      ...
                      var Y = { warnings: Q, longStackTraces: !1, cancellation: !1 }
                      return (
                        $ && n.longStackTraces(),
                        {
                ...
                12: [
                  function (t, e, n) {
                    ...
                    function r(t, e) {
                      function n(r) {
                        return this instanceof n
                          ? (h(this, "message", "string" == typeof r ? r : e),
                            h(this, "name", t),
                    ...
                    g ||
                      ...
                      h(Error, "__BluebirdErrorTypes__", g)),
                      (e.exports = {
                        Error: Error,
                        TypeError: o,
                        RangeError: s,
                  ...
                  function (t, e, n) {
                    ...
                    e.exports = function (e, n) {
                      ...
                      function a(t) {
                        ...
                        if (!this.called) {
                          this.called = !0
                          var h = 0 === this.type ? u.call(a._boundValue()) : u.call(a._boundValue(), t)
                          if (void 0 !== h) {
                            var f = n(h, a)
                            if (f instanceof e) {
                        ...
                        (e.prototype._passThrough = function (t, e, n, r) {
                          return "function" != typeof t
                            ...
                            : this._then(
                                ...
                                r,
                                void 0,
                                { promise: this, handler: t, called: !1, cancelPromise: null, type: e },
                                void 0
                              )
                        }),
                      ...
                      h.inherits(u, o),
                        ...
                        (u.prototype._promiseCancelled = function () {
                          if (!this._isResolved()) {
                            ...
                            var i = this._promise
                            this._cleanup(), t === f ? i._rejectCallback(t.e, !1) : i.cancel()
                          }
                        }),
                        ...
                        (u.prototype._continue = function (t) {
                          var n = this._promise
                          if (t === f) return this._cleanup(), n._rejectCallback(t.e, !1)
                          var r = t.value
                        ...
                        (a.prototype._promiseFulfilled = function (t, n) {
                          ...
                          if (0 > n) {
                            if (
                              ((n = -1 * n - 1),
                              (r[n] = t),
                              u >= 1 && (this._inFlight--, this._drainQueue(), this._isResolved()))
                            )
                              return !0
                          } else {
                            ...
                            var c = this._promise,
                              ...
                              p = c._boundValue()
                            c._pushContext()
                            var _ = h(l).call(p, t, n, o),
                              d = c._popContext()
                            if (
                              (s.checkForgottenReturns(_, d, null !== a ? "Promise.filter" : "Promise.map", c), _ === f)
                            )
                            ...
                            if (v instanceof e) {
                              ...
                              var y = v._bitField
                              if (0 === (50397184 & y))
                                return u >= 1 && this._inFlight++, (r[n] = v), v._proxy(this, -1 * (n + 1)), !1
                              if (0 === (33554432 & y))
                    ...
                    n.exports = function () {
                      ...
                      return (
                        ...
                        (i.prototype.spread = function (t) {
                          return "function" != typeof t
                            ? h("expecting a function but got " + p.classString(t))
                        ...
                        (i.fromNode = i.fromCallback =
                          function (t) {
                            var e = new i(b),
                              ...
                              r = O(t)(R(e, n))
                            return (
                              r === A && e._rejectCallback(r.e, !0), e._isFateSealed() || e._setAsyncGuaranteed(), e
                            )
                          }),
                        (i.all = function (t) {
                        ...
                        (i.cast = function (t) {
                          var e = j(t)
                          return e instanceof i || ((e = new i(b)), e._setFulfilled(), (e._rejectionHandler0 = t)), e
                        }),
                        ...
                        (i.prototype._then = function (t, e, n, r, o) {
                          ...
                          s ||
                            ...
                            void 0 === r &&
                              0 !== (2097152 & this._bitField) &&
                              (r = 0 !== (50397184 & l) ? this._boundValue() : c === this ? void 0 : this._boundTo))
                          var h = u()
                          if (0 !== (50397184 & l)) {
                            var f,
                              p,
                            ...
                            0 !== (33554432 & l)
                              ? ((p = c._rejectionHandler0), (f = t))
                              : 0 !== (16777216 & l)
                              ? ((p = c._fulfillmentHandler0), (f = e), c._unsetRejectionIsUnhandled())
                              : ((_ = c._settlePromiseLateCancellationObserver),
                                (p = new g("late cancellation observer")),
                          ...
                          } else c._addCallbacks(t, e, a, r, h)
                          return a
                        }),
                          ...
                          if (0 === (65536 & i)) {
                            ...
                            e === w
                              ? n && "number" == typeof n.length
                                ...
                                : ((o = A), (o.e = new m("cannot .spread() a non-array: " + p.classString(n))))
                              : (o = O(t).call(e, n))
                            var s = r._popContext()
                            if (((i = r._bitField), 0 === (65536 & i)))
                              if (o === C) r._reject(n)
                                ...
                                void 0 === o &&
                                  ...
                                  E.longStackTraces() &&
                                  E.warnings() &&
                                  r._warn("a promise was created in a handler but none were returned from it", !0),
                        ...
                        (i.prototype._settlePromise = function (t, e, r, o) {
                          ...
                          0 !== (65536 & a)
                            ? (s && t._invokeInternalOnCancel(),
                              e === T
                                ? ((r.cancelPromise = t), O(e).call(r, o) === A && t._reject(A.e))
                                : e === l
                                ? t._fulfill(l.call(r))
                                : r instanceof n
                            ...
                            : "function" == typeof e
                            ? s
                              ? (u && t._setAsyncGuaranteed(), this._settlePromiseFromHandler(e, r, o, t))
                              : e.call(r, o, t)
                            : r instanceof n
                            ? r._isResolved() ||
                              (0 !== (33554432 & a) ? r._promiseFulfilled(o, t) : r._promiseRejected(o, t))
                            : s && (u && t._setAsyncGuaranteed(), 0 !== (33554432 & a) ? t._fulfill(o) : t._reject(o))
                        }),
                        ...
                        p.notEnumerableProp(i, "_makeSelfResolutionError", c),
                        e("./method")(i, b, j, h, E),
                        e("./bind")(i, b, j, E),
                        e("./cancel")(i, F, h, E),
                        e("./direct_resolve")(i),
                        ...
                        e("./join")(i, F, j, b, E),
                        (i.Promise = i),
                        e("./map.js")(i, F, h, j, b, E),
                        e("./using.js")(i, h, j, x, b, E),
                        e("./timers.js")(i, b),
                        e("./generators.js")(i, h, b, j, n, E),
                        e("./nodeify.js")(i),
                        e("./call_get.js")(i),
                        e("./props.js")(i, F, j, h),
                        e("./race.js")(i, b, j, h),
                        e("./reduce.js")(i, F, h, j, b, E),
                        e("./settle.js")(i, F, E),
                        e("./some.js")(i, F, h),
                        e("./promisify.js")(i, b),
                        e("./any.js")(i),
                        e("./each.js")(i, b),
                        e("./filter.js")(i, b),
                        p.toFastProperties(i),
                        p.toFastProperties(i.prototype),
                        a({ a: 1 }),
                        a({ b: 2 }),
                        a({ c: 3 }),
                        a(1),
                        ...
                        a(!1),
                        a(new i(b)),
                        E.setBounds(d.firstLineError, p.lastLineError),
                        i
                      )
                    }
                  },
                      ...
                      return (
                        ...
                        (a.prototype._init = function t(n, o) {
                          ...
                          if (a instanceof e) {
                            ...
                            if (((this._values = a), 0 === (50397184 & c)))
                              return this._promise._setAsyncGuaranteed(), a._then(t, this._reject, void 0, this, o)
                            if (0 === (33554432 & c))
                          ...
                          return 0 === a.length
                            ? void (-5 === o ? this._resolveEmptyArray() : this._resolve(s(o)))
                        ...
                        (a.prototype._iterate = function (t) {
                          ...
                          for (var i = this._promise, o = !1, s = null, a = 0; n > a; ++a) {
                            var u = r(t[a], i)
                            u instanceof e ? ((u = u._target()), (s = u._bitField)) : (s = null),
                              o
                                ...
                                ? 0 === (50397184 & s)
                                  ...
                                  : (o =
                                      0 !== (33554432 & s)
                                        ...
                                        : 0 !== (16777216 & s)
                                        ? this._promiseRejected(u._reason(), a)
                    ...
                    e.exports = function (e, n) {
                      ...
                      function a(t, e, n, r) {
                        for (var a = p.inheritedDataKeys(t), u = [], c = 0; c < a.length; ++c) {
                          var l = a[c],
                            h = t[l],
                            f = r === j ? !0 : j(l, h, t)
                          "function" != typeof h || i(h) || o(t, l, e) || !r(l, h, t, f) || u.push(l, h)
                        }
                        return s(u, e, n), u
                      }
                      function u(t, r, i, o, s, a) {
                        ...
                        var c = (function () {
                          ...
                          l = t
                        return "string" == typeof l && (t = o), p.notEnumerableProp(u, "__isPromisified__", !0), u
                      }
                      ...
                      ;(e.promisify = function (t, e) {
                        ...
                        (e.promisifyAll = function (t, e) {
                          ...
                          var o = e.promisifier
                          if (("function" != typeof o && (o = k), !p.isIdentifier(r)))
                            throw new RangeError("suffix must be a valid identifier\n\n    See http://goo.gl/MqrFmX\n")
                          for (var s = p.inheritedDataKeys(t), a = 0; a < s.length; ++a) {
                            var u = t[s[a]]
                            "constructor" !== s[a] && p.isClass(u) && (c(u.prototype, r, i, o, n), c(u, r, i, o, n))
                          }
                          return c(t, r, i, o, n)
                        })
                    }
                  ...
                  function (t, e, n) {
                    ...
                    e.exports = function (e, n, r, i) {
                      ...
                      function s(t) {
                        ...
                        return c(s)
                          ? ((n =
                              s instanceof e ? s._then(e.props, void 0, void 0, void 0, void 0) : new o(s).promise()),
                  ...
                  function (t, e, n) {
                    ...
                    e.exports = function (e, n, r, i) {
                      function o(t, o) {
                        ...
                        for (var l = c._fulfill, h = c._reject, f = 0, p = t.length; p > f; ++f) {
                          var _ = t[f]
                          ;(void 0 !== _ || f in t) && e.cast(_)._then(l, h, void 0, c, null)
                        }
                        return c
                      }
                      var s = t("./util"),
                    ...
                    e.exports = function (e, n, r, i, o, s) {
                      ...
                      function l(t) {
                        ...
                        return n instanceof e
                          ? ((this.array._currentCancellable = n), n._then(h, void 0, void 0, this, void 0))
                          : h.call(this, n)
                      }
                      function h(t) {
                        var n = this.array,
                  ...
                  function (t, e, n) {
                    ...
                    e.exports = function (e, n) {
                      ...
                      function a(t, r, i) {
                        ...
                        var h = !0,
                          f = u.tryCatch(r).call(t, o, s)
                        return (h = !1), a && f === c && (a._rejectCallback(f.e, !0), (a = null)), l
                      }
                      var u = t("./util"),
                        c = u.errorObj,
                        l = u.isObject,
                    ...
                    e.exports = function (e, n) {
                      ...
                      var o = t("./util"),
                        ...
                        c = (e.delay = function (t, r) {
                          ...
                          return (
                            void 0 !== r
                              ? (i = e.resolve(r)._then(u, null, null, t, void 0))
                              : ((i = new e(n)),
                                setTimeout(function () {
                                  i._fulfill()
                                }, +t)),
                        ...
                        (e.using = function () {
                          ...
                          for (var u = new p(t), h = 0; t > h; ++h) {
                            ...
                            if (l.isDisposer(d)) {
                              ...
                              var g = r(d)
                              g instanceof e && (d = g._then(f, null, null, { resources: u, index: h }, void 0))
                            }
                            u[h] = d
                          }
                          for (var b = new Array(u.length), h = 0; h < b.length; ++h) b[h] = e.resolve(u[h]).reflect()
      ...
      function (t, e, n) {
        function r(t, e, n, r) {
          ...
          var s = 0,
            ...
            u = void 0 === r.palette ? null : r.palette
          ...
          if (null !== u) {
            ...
            if (((h = 1 << c), --c, void 0 !== r.background)) {
              if (((l = r.background), l >= h)) throw "Background index out of range."
          ...
          ;(this.addFrame = function (e, n, r, a, c, l) {
            if ((d === !0 && (--s, (d = !1)), (l = void 0 === l ? {} : l), 0 > e || 0 > n || e > 65535 || n > 65535))
              throw "x/y invalid."
            if (0 >= r || 0 >= a || r > 65535 || a > 65535) throw "Width/Height invalid."
            if (c.length < r * a) throw "Not enough pixels for the frame size."
            var h = !0,
              f = l.palette
            if (((void 0 === f || null === f) && ((h = !1), (f = u)), void 0 === f || null === f))
              throw "Must supply either a local or global palette."
            for (var p = o(f), _ = 0; (p >>= 1); ) ++_
            p = 1 << _
            var v = void 0 === l.delay ? 0 : l.delay,
              y = void 0 === l.disposal ? 0 : l.disposal
            if (0 > y || y > 3) throw "Disposal out of range."
            var m = !1,
              g = 0
            if (void 0 !== l.transparent && null !== l.transparent && ((m = !0), (g = l.transparent), 0 > g || g >= p))
        ...
        function i(t, e, n, r) {
          function i(n) {
            for (; f >= n; ) (t[e++] = 255 & p), (p >>= 8), (f -= 8), e === s + 256 && ((t[s] = 255), (s = e++))
          }
          function o(t) {
            ;(p |= t << f), (f += h), i(8)
          }
        ...
        function o(t) {
              ...
              case 33:
                switch (t[e++]) {
                  ...
                  case 249:
                    ...
                    var y = t[e++]
                    ;(f = t[e++] | (t[e++] << 8)), (p = t[e++]), 0 === (1 & y) && (p = null), (_ = (y >> 2) & 7), e++
                    break
                  case 254:
                    for (;;) {
                      var v = t[e++]
          ...
          ;(this.numFrames = function () {
            ...
            (this.frameInfo = function (t) {
              if (0 > t || t >= h.length) throw "Frame index out of range."
              return h[t]
            }),
              ...
              for (var y = 8, m = 0, g = a.length; g > m; ++m) {
                ...
                if (
                  (0 === f &&
                    ((d += v),
                    (f = l),
                    d >= _ && ((v = 4 * h + 4 * n * (y - 1)), (d = p + (l + h) * (y << 1)), (y >>= 1))),
                  b === c)
                )
                  d += 4
                else {
        ...
        function s(t, e, n, r) {
          for (
            var i = t[e++],
              ...
              f = 0,
              p = t[e++],
              _ = new Int32Array(4096),
              d = null;
            ;

          ) {
            for (; 16 > l && 0 !== p; ) (h |= t[e++] << l), (l += 8), 1 === p ? (p = t[e++]) : --p
            if (u > l) break
            var v = h & c
            if (((h >>= u), (l -= u), v !== o)) {
              if (v === s) break
              ...
              ;(n[f++] = b), (f += m)
              var C = f
              for (y !== v && (n[f++] = b), g = y; m--; ) (g = _[g]), (n[--C] = 255 & g), (g >>= 8)
